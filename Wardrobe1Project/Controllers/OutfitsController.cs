...
namespace Wardrobe1Project.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OutfitID,TopID,BottomID,ShoeID,AccessoriesID")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,TopID,BottomID,ShoeID,AccessoriesID")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
